...
$products = $data->fetch(PDO::FETCH_ASSOC);
$cat = $products['cat'];
$data = $db->select("*","furniture","cat='$cat' and id !='$id'");
$sim_pro = $data->fetchAll(PDO::FETCH_ASSOC);
}
                        ...
                        <div class="login-sr">
                           <div class="login-signup">
                              ...
                              <form method = "POST" action = "<?php $_SERVER['PHP_SELF']; ?>">
                                 <li><a href="admin/login.php">Login/Registeration</a></li>
                                 <li><input type="submit" name = "admin"  <?php if($user == '0') echo "disabled"; ?>   value = "Admin"></li>
                              </ul>
                           </div>
                        </div>
            ...
            <div class="container">
               <div class="row">
                  <ol class="breadcrumb">
                     ...
                     <li class="active"><?php if(isset($_GET['catname']))echo $_GET['catname']; ?></li>
                     <li><a href="#"></li>
                  </ol>
               </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-md-7 col-sm-8">
                  <div class="md-prod-page">
                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 ...
                                 <div class="tab-pane active" id="pic-1"><img src="./images/<?php echo $products['image'];?>" alt="#" width = "800"  height="1000" /></div>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           <h4>Description</h4>
                           <p><?php echo $products['descr'];?>
                           </p>
                           <br>
                           <p>Small: <?php echo $products['small'];?></p>
                           <p>Large : <?php echo $products['large'];?></p>
                        </div>
                        <div class="spe-a">
                  ...
                  <div class="similar-box">
                     ...
                     <?php  $i=1; $j = 4;
                      foreach($sim_pro as $s)
                        {
                           if($j > 0)
                           {
                            if ($i>0)
                            {?>
                           <div class="row cat-pd"><?php
                            }?>
                        <div class="col-md-6">
                           <div class="small-box-c">
                              <div class="small-img-b">
                                 <img class="img-responsive" src="<?php echo "images/".$s['image'];?>" alt="#" width ="800" height="1000" />
                              </div>
                               <div class="dit-t clearfix">
                                 <div class="left-ti">
                                    <h4><?php echo $s['title']; ?></h4>
                                    <p>By <span>Beko</span> under <span>$s['cat_name'];?></span></p>
                                 </div>
                                 <a href="#" tabindex="0">$<?php echo $s['price'];?></a>
                              </div>
                              <div class="prod-btn">
                                 <a href="#"><i class="fa fa-star" aria-hidden="true"></i> Save to wishlist</a>
                                 <a href="#"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Like this</a>
               ...
               <div class="col-md-3 col-sm-12">
                  <div class="price-box-right">
                     <h4>Price</h4>
                     <h3>$<?php echo $products['price'];?><span>pr.peice</span></h3>
                     <p>Option</p>
