...
?>              
               ...
               <div class="row clearfix">
                  <div class="col-lg-3 col-sm-6 col-md-3">
                     <a href="productpage.php?id=<?php echo $pro['id'];?>&catname=<?php echo $pro['name'];?>">
                        <div >
                           <font  size = "6"  color="blue"><?php echo "          ". $pro['name'];?></font>
                           <img width="800" height="1000" src="images/product/<?php echo $pro['image'];?>"/>
                        </div>
                     </a>
                  </div><?php $i= $i-1; 
               }
